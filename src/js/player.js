...
window.playerTips = `<div class="learn_points">
    ...
    <div class="case">
        ...
        4、认真听句子发音，并模仿发音。模仿发音时，需要忘掉所有文字，脑海里应浮现出句子运用的场景，当现在的自己是一个演员，把自己置身在场景中，投入感情和动用感官（视觉，听觉，嗅觉，味觉，触觉）去模仿。<br>
        5、认真听自己的发音和原音的差异。<br>
        6、重复第 4-5 步，修正自己的发音。直到你感觉语速能跟上，发音接近，并且很流利为止。「练习次数多多益善」
    </div>
</div>
...
<div class="learn_points">
    ...
    <div class="case">
        如果感觉语速跟不上，这证明缺乏锻炼，不要想着去降低播放速度，而需要强迫自己锻炼你的耳朵和嘴巴。开始练习发音吧，当你重复练习 N 次后，你会感觉语速变慢了。相信自己，你可以的！
    </div>
</div>
