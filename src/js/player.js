...
window.playerTips = `<div class="learn_points">
    ...
    <div class="case">
        1、练句子，把生词融入句子中。<br>
        2、先理解句子含义。如有生词时，应先根据经验猜，然后才查词典确认猜的对不对。首选查英英词典，推荐朗文或格林斯之类的词典，把英语当工具使用，用英语思维去学习生词。如果还没达到这个能力，才考虑查中英词典。当理解含义后，忘掉所有文字，不管中文还是英文，理解含义为最终目的。<br>
        3、认真听句子发音，并模仿发音。模仿发音时，需要忘掉所有文字，脑海里应浮现出句子运用的场景，把自己置身在场景中，你可以当自己现在是一个演员，投入感情和动用感官（视觉，听觉，嗅觉，味觉，触觉）去模仿。<br>
        4、认真听自己的发音和原音的差异。<br>
        5、重复第3-4步。直到你感觉语速能跟上，发音接近，并且很流利为止。当然重复练习次数多多益善。
    </div>
</div>
...
<div class="learn_points">
    ...
    <div class="case">
        如果感觉语速跟不上，这证明缺乏锻炼，不要想着去降低播放速度，而需要强迫你的耳朵和嘴巴能跟上速度。开始练习发音吧，当你重复练习N次后，你会感觉语速变慢了。相信自己，你可以的！
    </div>
</div>
...
<div class="learn_points">
    ...
    <div class="case">
        语言是技能，最重要的是实战运用。所以句子练熟之后呢？就需要去使用这些句子，最好找外国人去使用这些句子；如果没有外国人当陪练？那就找英语口语好的朋友当你的陪练；如果口语好的朋友也没有？那只能自言自语了，自己和自己对话。
    </div>
</div>`
