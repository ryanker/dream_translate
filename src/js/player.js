...
window.playerTips = `<div class="learn_points">
    ...
    <div class="case">
        ...
        3、认真听句子发音，并模仿发音。模仿发音时，需要忘掉所有文字，脑海里应浮现出句子运用的场景，把自己置身在场景中，投入感情和动用感官（视觉，听觉，嗅觉，味觉，触觉）去模仿。<br>
        4、认真听自己的发音和原音的差异。<br>
...
<div class="learn_points">
    ...
    <div class="case">
        语言是技能，最重要的是实战运用。所以句子练熟之后呢？就需要去使用这些句子，如果你有个友好耐心的老外朋友当陪练那当然最好，没有也不用特别在意，很多学者都发现，在学习外语过程中，跟自己说话，要比跟别人交流更高效。
    </div>
</div>`
